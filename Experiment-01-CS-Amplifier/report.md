...
Here u can see that without load capacitor the bandwidth is higher,B.W=Fh-Fl=88.3GHz which is a significant increase in the B.W showing how load capacitance creates the dominant pole.
